...
export class Debug {
  ...
  _shouldLog(type) {
    ...
    const levelCheck =
      typeLevel >= this.minLevel && typeLevel >= Debug.globalLevel;
  ...
  `;
    ...
    if (data !== null && data !== undefined) {
      this.logger.log(
        "%c└─ Data:",
        `color: ${color}; font-style: ${this.theme.data.fontStyle};`,
        data,
      );
    }
  }
  ...
  table(data) {
    ...
    this.logger.log(
      `%c${this.context} 📊 Table:`,
      `color: ${this.colors.data}; font-weight: ${this.theme.table.fontWeight};`,
    );
  ...
  trace(message = "Stack trace") {
    ...
    this.logger.log(
      ...
      `color: ${this.colors.debug}; font-weight: ${this.theme.trace.fontWeight};`,
    );
    this.logger.trace();
  }
  ...
  separator(label = "") {
    ...
    if (label) {
      this.logger.log(
        `%c${label}`,
        `color: ${this.theme.separator.labelColor}; font-weight: ${this.theme.separator.fontWeight}; text-align: ${this.theme.separator.textAlign};`,
      );
      this.logger.log(`%c${line}`, `color: ${this.theme.separator.lineColor};`);
    }
  }
