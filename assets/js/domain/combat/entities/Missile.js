...
export class Missile extends Entity {
  ...
  constructor(
    ...
    const speedInPixels = coordSystem
      ? coordSystem.cellsToPixels(speed)
      : speed * 50;
  ...
  update(deltaTime) {
    ...
    if (distanceToTarget < 5) {
      ...
      const splashRadiusPixels = this.coordSystem
        ? this.coordSystem.cellsToPixels(this.attributes.splashRadius)
        : this.attributes.splashRadius;
