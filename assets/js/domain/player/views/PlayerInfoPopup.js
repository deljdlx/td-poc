...
export class PlayerInfoPopup {
  ...
  updateInfo(deltaTime) {
    ...
    if (this.resourceElements.money) {
      this.resourceElements.money.textContent = this.currentPlayer.wallet
        .get("money")
        .toLocaleString();
    }
    if (this.resourceElements.mana) {
      this.resourceElements.mana.textContent =
        this.currentPlayer.wallet.get("mana");
    }
    if (this.resourceElements.gems) {
      this.resourceElements.gems.textContent =
        this.currentPlayer.wallet.get("gems");
    }
    ...
    if (this.resourceElements.score) {
      this.resourceElements.score.textContent =
        this.currentPlayer.score.toLocaleString();
    }
    if (this.resourceElements.towers) {
      this.resourceElements.towers.textContent =
        this.currentPlayer.towers.length;
    }
    if (this.resourceElements.kills) {
      this.resourceElements.kills.textContent =
        this.currentPlayer.stats.enemiesKilled.toLocaleString();
    }
    if (this.resourceElements.waves) {
      this.resourceElements.waves.textContent =
        this.currentPlayer.stats.wavesCompleted;
    }
  }
